...
!function (t, e) {
    ...
    var e = function (t, e, n) {
        ...
        var f = [], h = f.slice, p = f.concat, m = Array.isArray, v = e.documentElement, g = {}, b = function (t) {
        ...
        x.fn = b.prototype, x.extend = x.fn.extend = function (t) {
            ...
            each: function (t) {
                ...
                return "fixed" === this.css("position") ? e = this[0].getBoundingClientRect() : (t = this.offsetParent(), e = this.offset(), function (t, e) {
                ...
                return this.each(function () {
                    "none" === this.style.display && (this.style.display = ""), "none" === t.getComputedStyle(this, "").getPropertyValue("display") && (this.style.display = function (t) {
                        var n, i;
                        return g[t] || (n = e.createElement(t), e.body.appendChild(n), i = getComputedStyle(n, "").getPropertyValue("display"), n.parentNode.removeChild(n), "none" === i && (i = "block"), g[t] = i), g[t]
                    }(this.nodeName))
                })
            }, hide: function () {
                return this.each(function () {
                ...
                var e = u(t) ? this.find(t) : x(t), n = e.length;
                ...
                return i && i.elements ? (x(h.call(i.elements)).each(function () {
                    t = x(this), e = t.attr("type"), "fieldset" === this.nodeName.toLowerCase() || this.disabled || -1 !== ["submit", "reset", "button"].indexOf(e) || -1 !== ["radio", "checkbox"].indexOf(e) && !this.checked || n.push({
                        name: t.attr("name"),
                        value: t.val()
                    })
                }), n) : n
            ...
            x.fn[i] = function (o) {
                if (o === n) {
                    ...
                    var s = x(a), r = 0, c = "width" === i;
                    return "ActiveXObject" in t && "border-box" === s.css("box-sizing") && (r = parseFloat(s.css("padding-" + (c ? "left" : "top"))) + parseFloat(s.css("padding-" + (c ? "right" : "bottom"))) + parseFloat(s.css("border-" + (c ? "left" : "top") + "-width")) + parseFloat(s.css("border-" + (c ? "right" : "bottom") + "-width"))), parseFloat(x(a).css(i)) + r
                }
                return isNaN(Number(o)) || "" === o || (o += "px"), this.css(i, o)
            }
        }), o({Width: "width", Height: "height"}, function (t, e) {
            x.fn["inner" + t] = function () {
                var t = this[e](), n = x(this[0]);
        ...
        return o(["", "All", "Until"], function (t, e) {
            ...
            x.fn[n] = function (n) {
                ...
                if (u(n)) {
                    ...
                    s.innerHTML = n, i = h.call(s.childNodes)
                } else i = x(n).get();
            ...
            x.fn.extend({
                ready: function (t) {
                    ...
                    var h = this;
                    if (t && !u(t)) return o(t, function (t, n) {
                        h.on(t, e, i, n)
                    }), h;
                    if (u(e) || d(r) || !1 === r || (r = i, i = e, e = n), (d(i) || !1 === i) && (r = i, i = n), !1 === r && (r = c), 1 === f) {
                        var p = r;
                        r = function () {
                            return h.off(t, e, r), p.apply(this, arguments)
                        }
                    }
                    return this.each(function () {
                        !function (t, e, i, o, r) {
                            ...
                            s[c] || (s[c] = []);
                            var d = !1;
                            l(o) && o.useCapture && (d = !0), e.split(" ").forEach(function (e) {
                                var a = {e: e, fn: i, sel: r, i: s[c].length}, u = function (t, e) {
            ...
            x.extend({
                ajaxSetup: function (t) {
                    ...
                    T.open(y, l.url, l.async, l.username, l.password), ($ && !r(y) && !1 !== l.contentType || l.contentType) && T.setRequestHeader("Content-Type", l.contentType), "json" === l.dataType && T.setRequestHeader("Accept", "application/json, text/javascript"), l.headers && o(l.headers, function (t, e) {
                    ...
                    return T.onload = function () {
                        ...
                        } else t = "error", f(s.ajaxError, b), h("error", T, t);
                        ...
                        var t = "abort";
                        E && (t = "timeout", clearTimeout(E)), f(s.ajaxError, b), h("error", T, t), f(s.ajaxComplete, b), h("complete", T, t)
    ...
    e.fn.extend({
        ...
        function t(t, i) {
            if (this.$headroom = e(t).eq(0), this.$headroom.length) {
                ...
                a !== Object(a) && (this.options.tolerance = {down: a, up: a}), this._init()
            }
        }
    ...
    return t.Collapse = function () {
            ...
            delay: 200, show: function (t, n) {
                if (2 !== t.button) {
                    var i, o = (i = "touches" in t && t.touches.length ? t.touches[0] : t).pageX, a = i.pageY,
                        s = n.offset(), r = o - s.left, c = a - s.top, d = n.innerHeight(), u = n.innerWidth(),
        ...
        n.on("input focus blur", ".mdui-textfield-input", {useCapture: !0}, function (t) {
            ...
            if (!(["checkbox", "button", "submit", "range", "radio", "image"].indexOf(d) >= 0)) {
                ...
                if ("focus" === a && u.addClass("mdui-textfield-focus"), "blur" === a && u.removeClass("mdui-textfield-focus"), "blur" !== a && "input" !== a || u[s && "" !== s ? "addClass" : "removeClass"]("mdui-textfield-not-empty"), u[n.disabled ? "addClass" : "removeClass"]("mdui-textfield-disabled"), "input" !== a && "blur" !== a || c || !n.validity || u[n.validity.valid ? "removeClass" : "addClass"]("mdui-textfield-invalid-html5"), "textarea" === t.target.nodeName.toLowerCase()) {
                    ...
                    var h = o.height(), p = n.scrollHeight;
                    p > h && o.height(p), f && o.val(l)
                }
        ...
        return t.prototype.open = function () {
            var t = this;
            "opening" !== t.state && "opened" !== t.state && (t.state = "opening", r("open", "select", t, t.$selectNative), function (t) {
                var e, n, o = i.height(), a = t.options.gutter, s = t.options.position,
                    r = parseInt(t.$select.height()), c = t.$items.eq(0), d = parseInt(c.height()),
                    u = parseInt(c.css("margin-top")), l = parseFloat(t.$select.width() + .01), f = d * t.size + 2 * u,
                    h = t.$select[0].getBoundingClientRect().top;
                if ("auto" === s) {
                    var p = o - 2 * a;
                    f > p && (f = p), n = -(u + t.selectedIndex * d + (d - r) / 2);
                    var m = -(u + (t.size - 1) * d + (d - r) / 2);
                    n < m && (n = m);
                    var v = h + n;
                    v < a ? n = -(h - a) : v + f + a > o && (n = -(h + f + a - o)), e = t.selectedIndex * d + d / 2 + u + "px"
        ...
        return t.prototype._bindTabEvent = function (t) {
            ...
            var t, e;
            !1 !== this.activeIndex ? (t = this.$tabs.eq(this.activeIndex), o(t) || (e = t.offset(), this.$indicator.css({
        ...
        var n = {overlay: !1, swipe: !1}, o = function () {
            ...
            function s(e) {
                u = e.touches[0].pageX, "right" === t.position && (u = m.width() - u), l = e.touches[0].pageY, "opened" !== t.state && (u > v || d !== s) || (p = !0, m.on({
                    touchmove: r,
                    touchend: c,
                    touchcancel: r
                }))
            ...
            function c(n) {
                if (h) {
                    ...
                    p = !1;
                    var u = h;
                    h = null, "opening" === u ? d < .92 ? (i(), t.open()) : i() : d > .08 ? (i(), t.close()) : i(), e.unlockScreen()
                } else p = !1;
        ...
        }, n || {}), e.each(n.buttons, function (t, o) {
            n.buttons[t] = e.extend({}, i, o)
        });
        var o = "";
        n.buttons.length && (o = '<div class="mdui-dialog-actions ' + (n.stackedButtons ? "mdui-dialog-actions-stacked" : "") + '">', e.each(n.buttons, function (t, e) {
        ...
        return a = e.extend({}, {confirmText: "ok", history: !0, modal: !1, closeOnEsc: !0}, a), t.dialog({
            title: i,
            content: n,
        ...
        function t(t, i) {
            ...
            if (o.$target = e(t).eq(0), o.$target.length) {
                ...
                if (s) return s;
                o.options = e.extend({}, n, i || {}), o.state = "closed", o.$tooltip = e('<div class="mdui-tooltip" id="' + e.guid() + '">' + o.options.content + "</div>").appendTo(document.body), o.$target.on("touchstart mouseenter", function (t) {
        ...
        var n = {position: "auto", delay: 0, content: ""}, o = function () {
            return i.width() > 1024
        }, c = function (t) {
        ...
        return t.prototype._doOpen = function () {
            ...
            if ("opening" !== n.state && "opened" !== n.state) {
                ...
                e.extend(n.options, s(n.$target.attr("mdui-tooltip"))), t && e.extend(n.options, t), a.content !== n.options.content && n.$tooltip.html(n.options.content), function (t) {
                    var e, n, a, s = t.$target[0].getBoundingClientRect(), r = o() ? 14 : 24,
                        c = t.$tooltip[0].offsetWidth, d = t.$tooltip[0].offsetHeight;
                    switch (a = t.options.position, -1 === ["bottom", "top", "left", "right"].indexOf(a) && (a = s.top + s.height + r + d + 2 < i.height() ? "bottom" : r + d + 2 < s.top ? "top" : r + c + 2 < s.left ? "left" : s.width + r + c + 2 < i.width() - s.left ? "right" : "bottom"), a) {
                        case"bottom":
                            e = c / 2 * -1, n = s.height / 2 + r, t.$tooltip.transformOrigin("top center");
                            break;
                        case"top":
                            e = c / 2 * -1, n = -1 * (d + s.height / 2 + r), t.$tooltip.transformOrigin("bottom center");
                            break;
                        case"left":
                            e = -1 * (c + s.width / 2 + r), n = d / 2 * -1, t.$tooltip.transformOrigin("center right");
                            break;
                        case"right":
                            e = s.width / 2 + r, n = d / 2 * -1, t.$tooltip.transformOrigin("center left")
                    }
        ...
        function i(t, n) {
            if (this.message = t, this.options = e.extend({}, r, n || {}), this.message) {
                ...
                var i = "", o = "";
                0 === this.options.buttonColor.indexOf("#") || 0 === this.options.buttonColor.indexOf("rgb") ? i = 'style="color:' + this.options.buttonColor + '"' : "" !== this.options.buttonColor && (o = "mdui-text-color-" + this.options.buttonColor), this.$snackbar = e('<div class="mdui-snackbar"><div class="mdui-snackbar-text">' + this.message + "</div>" + (this.options.buttonText ? '<a href="javascript:void(0)" class="mdui-snackbar-action mdui-btn mdui-ripple mdui-ripple-white ' + o + '" ' + i + ">" + this.options.buttonText + "</a>" : "") + "</div>").appendTo(document.body), this._setPosition("close"), this.$snackbar.reflow().addClass("mdui-snackbar-" + this.options.position)
            }
        }
        ...
        var o = {
            ...
            var e, n, o, a, s, r, c = i.height(), d = i.width(), u = t.options.gutter, l = t.isCovered,
                f = t.options.fixed, h = t.$menu.width(), p = t.$menu.height(), m = t.$anchor,
                v = m[0].getBoundingClientRect(), g = v.top, b = v.left, x = v.height, y = v.width, $ = c - g - x,
                w = d - b - y, C = m[0].offsetTop, k = m[0].offsetLeft;
            if (o = "auto" === t.options.position ? $ + (l ? x : 0) > p + u ? "bottom" : g + (l ? x : 0) > p + u ? "top" : "center" : t.options.position, a = "auto" === t.options.align ? w + y > h + u ? "left" : b + y > h + u ? "right" : "center" : t.options.align, "bottom" === o) r = "0", n = (l ? 0 : x) + (f ? g : C); else if ("top" === o) r = "100%", n = (l ? x : 0) + (f ? g - p : C - p); else {
                r = "50%";
                var O = p;
                t.isCascade || p + 2 * u > c && (O = c - 2 * u, t.$menu.height(O)), n = (c - O) / 2 + (f ? 0 : C - g)
            }
            if (t.$menu.css("top", n + "px"), "left" === a) s = "0", e = f ? b : k; else if ("right" === a) s = "100%", e = f ? b + y - h : k + y - h; else {
                s = "50%";
                var T = h;
                h + 2 * u > d && (T = d - 2 * u, t.$menu.width(T)), e = (d - T) / 2 + (f ? 0 : k - b)
            }
            t.$menu.css("left", e + "px"), t.$menu.transformOrigin(s + " " + r)
        }, s = function (t) {
            !function (t) {
                var e, n, o, a, s, r, c = t.parent(".mdui-menu-item"), d = i.height(), u = i.width(), l = t.width(),
                    f = t.height(), h = c[0].getBoundingClientRect(), p = h.width, m = h.height, v = h.left, g = h.top;
                o = d - g > f ? "bottom" : g + m > f ? "top" : "bottom", a = u - v - p > l ? "left" : v > l ? "right" : "left", "bottom" === o ? (r = "0", e = "0") : "top" === o && (r = "100%", e = -f + m), t.css("top", e + "px"), "left" === a ? (s = "0", n = p) : "right" === a && (s = "100%", n = -l), t.css("left", n + "px"), t.transformOrigin(s + " " + r)
            ...
            if (t.$menu.on("click", ".mdui-menu-item", function (t) {
                ...
                t.$menu.on("mouseover mouseout", ".mdui-menu-item", function (a) {
                    var r = e(this), d = a.type, u = e(a.relatedTarget);
                    if (null === r.attr("disabled")) {
                        ...
                        if ("mouseover" === d) {
                            ...
                            h && clearTimeout(h), n = o = setTimeout(function () {
                                c(l)
